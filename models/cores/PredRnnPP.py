...
from ..components.Component import CausalLSTMCell, GradientHighwayUnit
...
class PredRnnPP(nn.Module):
    def __init__(
        ...
        self.gradientHighwayUnit = GradientHighwayUnit(
            in_channel=num_hidden[0],
    ...
    def forward(
        ...
        for t in range(totalLength - 1):
            ...
            z_t = self.gradientHighwayUnit(h_t[0], z_t)
